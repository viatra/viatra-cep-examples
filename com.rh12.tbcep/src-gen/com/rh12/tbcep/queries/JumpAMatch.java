...
/**
 * Pattern-specific match representation of the com.rh12.tbcep.queries.jumpA pattern,
 * to be used in conjunction with {@link JumpAMatcher}.
 * 
...
public abstract class JumpAMatch extends BasePatternMatch {
  private Sensor fSensor;
  
  private static List<String> parameterNames = makeImmutableList("sensor");
  
  private JumpAMatch(final Sensor pSensor) {
  ...
  public List<String> parameterNames() {
    return JumpAMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof JumpAMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    JumpAMatch other = (JumpAMatch) obj;
  ...
  @Override
  public JumpAQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JumpAMatch newEmptyMatch() {
   ...
   * 
   */
  public static JumpAMatch newMutableMatch(final Sensor pSensor) {
   ...
   * 
   */
  public static JumpAMatch newMatch(final Sensor pSensor) {
    return new Immutable(pSensor);
  }
  
  private static final class Mutable extends JumpAMatch {
  ...
  private static final class Immutable extends JumpAMatch {
