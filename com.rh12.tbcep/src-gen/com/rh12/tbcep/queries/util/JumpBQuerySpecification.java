...
/**
 * A pattern-specific query specification that can instantiate JumpBMatcher in a type-safe way.
 * 
 * @see JumpBMatcher
 * @see JumpBMatch
 * 
...
public final class JumpBQuerySpecification extends BaseGeneratedEMFQuerySpecification<JumpBMatcher> {
  private JumpBQuerySpecification() {
   ...
   * 
   */
  public static JumpBQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected JumpBMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return JumpBMatcher.on(engine);
  }
  
  @Override
  public JumpBMatch newEmptyMatch() {
    return JumpBMatch.newEmptyMatch();
  }
  
  @Override
  public JumpBMatch newMatch(final Object... parameters) {
    return JumpBMatch.newMatch((model.Sensor) parameters[0]);
  }
  
  private static class LazyHolder {
    private final static JumpBQuerySpecification INSTANCE = make();
    
    public static JumpBQuerySpecification make() {
      return new JumpBQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static JumpBQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "com.rh12.tbcep.queries.jumpB";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern jumpB";
      		                            }
