...
/**
 * A pattern-specific query specification that can instantiate SensorZPlusMatcher in a type-safe way.
 * 
 * @see SensorZPlusMatcher
 * @see SensorZPlusMatch
 * 
 */
@SuppressWarnings("all")
public final class SensorZPlusQuerySpecification extends BaseGeneratedEMFQuerySpecification<SensorZPlusMatcher> {
  private SensorZPlusQuerySpecification() {
   ...
   * 
   */
  public static SensorZPlusQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected SensorZPlusMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return SensorZPlusMatcher.on(engine);
  }
  
  @Override
  public SensorZPlusMatch newEmptyMatch() {
    return SensorZPlusMatch.newEmptyMatch();
  }
  
  @Override
  public SensorZPlusMatch newMatch(final Object... parameters) {
    return SensorZPlusMatch.newMatch((model.Sensor) parameters[0]);
  }
  
  private static class LazyHolder {
    private final static SensorZPlusQuerySpecification INSTANCE = make();
    
    public static SensorZPlusQuerySpecification make() {
      return new SensorZPlusQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SensorZPlusQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "com.rh12.tbcep.queries.sensorZPlus";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern sensorZPlus";
      		                            }
