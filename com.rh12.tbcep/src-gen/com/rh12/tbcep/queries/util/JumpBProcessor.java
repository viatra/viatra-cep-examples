...
/**
 * A match processor tailored for the com.rh12.tbcep.queries.jumpB pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class JumpBProcessor implements IMatchProcessor<JumpBMatch> {
  /**
  ...
  @Override
  public void process(final JumpBMatch match) {
