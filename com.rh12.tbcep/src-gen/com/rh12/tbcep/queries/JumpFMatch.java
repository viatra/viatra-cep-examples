...
/**
 * Pattern-specific match representation of the com.rh12.tbcep.queries.jumpF pattern,
 * to be used in conjunction with {@link JumpFMatcher}.
 * 
...
public abstract class JumpFMatch extends BasePatternMatch {
  private Sensor fSensor;
  
  private static List<String> parameterNames = makeImmutableList("sensor");
  
  private JumpFMatch(final Sensor pSensor) {
  ...
  public List<String> parameterNames() {
    return JumpFMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof JumpFMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    JumpFMatch other = (JumpFMatch) obj;
  ...
  @Override
  public JumpFQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JumpFMatch newEmptyMatch() {
   ...
   * 
   */
  public static JumpFMatch newMutableMatch(final Sensor pSensor) {
   ...
   * 
   */
  public static JumpFMatch newMatch(final Sensor pSensor) {
    return new Immutable(pSensor);
  }
  
  private static final class Mutable extends JumpFMatch {
  ...
  private static final class Immutable extends JumpFMatch {
