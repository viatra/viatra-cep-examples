...
/**
 * Pattern-specific match representation of the com.rh12.tbcep.queries.jumpH pattern,
 * to be used in conjunction with {@link JumpHMatcher}.
 * 
...
public abstract class JumpHMatch extends BasePatternMatch {
  private Sensor fSensor;
  
  private static List<String> parameterNames = makeImmutableList("sensor");
  
  private JumpHMatch(final Sensor pSensor) {
  ...
  public List<String> parameterNames() {
    return JumpHMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof JumpHMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    JumpHMatch other = (JumpHMatch) obj;
  ...
  @Override
  public JumpHQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JumpHMatch newEmptyMatch() {
   ...
   * 
   */
  public static JumpHMatch newMutableMatch(final Sensor pSensor) {
   ...
   * 
   */
  public static JumpHMatch newMatch(final Sensor pSensor) {
    return new Immutable(pSensor);
  }
  
  private static final class Mutable extends JumpHMatch {
  ...
  private static final class Immutable extends JumpHMatch {
