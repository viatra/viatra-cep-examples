...
/**
 * Pattern-specific match representation of the com.rh12.tbcep.queries.jumpD pattern,
 * to be used in conjunction with {@link JumpDMatcher}.
 * 
...
public abstract class JumpDMatch extends BasePatternMatch {
  private Sensor fSensor;
  
  private static List<String> parameterNames = makeImmutableList("sensor");
  
  private JumpDMatch(final Sensor pSensor) {
  ...
  public List<String> parameterNames() {
    return JumpDMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof JumpDMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    JumpDMatch other = (JumpDMatch) obj;
  ...
  @Override
  public JumpDQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JumpDMatch newEmptyMatch() {
   ...
   * 
   */
  public static JumpDMatch newMutableMatch(final Sensor pSensor) {
   ...
   * 
   */
  public static JumpDMatch newMatch(final Sensor pSensor) {
    return new Immutable(pSensor);
  }
  
  private static final class Mutable extends JumpDMatch {
  ...
  private static final class Immutable extends JumpDMatch {
