...
/**
 * Pattern-specific match representation of the com.rh12.tbcep.queries.jumpB pattern,
 * to be used in conjunction with {@link JumpBMatcher}.
 * 
...
public abstract class JumpBMatch extends BasePatternMatch {
  private Sensor fSensor;
  
  private static List<String> parameterNames = makeImmutableList("sensor");
  
  private JumpBMatch(final Sensor pSensor) {
  ...
  public List<String> parameterNames() {
    return JumpBMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof JumpBMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    JumpBMatch other = (JumpBMatch) obj;
  ...
  @Override
  public JumpBQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JumpBMatch newEmptyMatch() {
   ...
   * 
   */
  public static JumpBMatch newMutableMatch(final Sensor pSensor) {
   ...
   * 
   */
  public static JumpBMatch newMatch(final Sensor pSensor) {
    return new Immutable(pSensor);
  }
  
  private static final class Mutable extends JumpBMatch {
  ...
  private static final class Immutable extends JumpBMatch {
