...
/**
 * Pattern-specific match representation of the com.rh12.tbcep.queries.sensorZPlus pattern,
 * to be used in conjunction with {@link SensorZPlusMatcher}.
 * 
...
public abstract class SensorZPlusMatch extends BasePatternMatch {
  private Sensor fSensor;
  
  private static List<String> parameterNames = makeImmutableList("sensor");
  
  private SensorZPlusMatch(final Sensor pSensor) {
  ...
  public List<String> parameterNames() {
    return SensorZPlusMatch.parameterNames;
  }
  ...
  @Override
  public SensorZPlusMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SensorZPlusMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SensorZPlusMatch other = (SensorZPlusMatch) obj;
  ...
  @Override
  public SensorZPlusQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SensorZPlusMatch newEmptyMatch() {
   ...
   * 
   */
  public static SensorZPlusMatch newMutableMatch(final Sensor pSensor) {
   ...
   * 
   */
  public static SensorZPlusMatch newMatch(final Sensor pSensor) {
    return new Immutable(pSensor);
  }
  
  private static final class Mutable extends SensorZPlusMatch {
  ...
  private static final class Immutable extends SensorZPlusMatch {
