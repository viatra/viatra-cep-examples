...
import com.rh12.tbcep.vepl.jobs.InERuleA_Job;
...
public class InERuleA implements ICepRule {
  private List<EventPattern> eventPatterns = Lists.newArrayList();
  
  private CepJob<IObservableComplexEventPattern> job = new InERuleA_Job(CepActivationStates.ACTIVE);
