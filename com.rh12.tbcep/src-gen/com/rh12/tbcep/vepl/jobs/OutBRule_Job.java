...
public class OutBRule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutBRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(B) OUT       ", CLog.ATOMIC_OUT);
  }
