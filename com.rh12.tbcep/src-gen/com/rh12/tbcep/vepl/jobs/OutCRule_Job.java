...
public class OutCRule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutCRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(C) OUT       ", CLog.ATOMIC_OUT);
  }
