...
public class InDRuleA_Job extends CepJob<IObservableComplexEventPattern> {
  public InDRuleA_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(   D    )    ", CLog.ATOMIC);
  }
