...
public class OutARule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutARule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(A) OUT       ", CLog.ATOMIC_OUT);
  }
