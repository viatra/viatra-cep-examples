...
public class InERule_Job extends CepJob<IObservableComplexEventPattern> {
  public InERule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(E) IN        ", CLog.ATOMIC_IN);
  }
