...
public class InARuleA_Job extends CepJob<IObservableComplexEventPattern> {
  public InARuleA_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(A       )    ", CLog.ATOMIC);
  }
