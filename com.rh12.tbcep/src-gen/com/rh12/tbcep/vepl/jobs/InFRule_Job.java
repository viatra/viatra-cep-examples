...
public class InFRule_Job extends CepJob<IObservableComplexEventPattern> {
  public InFRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(F) IN        ", CLog.ATOMIC_IN);
  }
