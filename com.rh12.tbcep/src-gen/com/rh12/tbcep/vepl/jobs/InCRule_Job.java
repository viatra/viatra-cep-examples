...
public class InCRule_Job extends CepJob<IObservableComplexEventPattern> {
  public InCRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(C) IN        ", CLog.ATOMIC_IN);
  }
