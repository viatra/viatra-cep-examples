...
public class InBRule_Job extends CepJob<IObservableComplexEventPattern> {
  public InBRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(B) IN        ", CLog.ATOMIC_IN);
  }
