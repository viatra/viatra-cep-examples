...
public class OutHRule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutHRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(H) OUT       ", CLog.ATOMIC_OUT);
  }
