...
public class InFRuleA_Job extends CepJob<IObservableComplexEventPattern> {
  public InFRuleA_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(     F  )    ", CLog.ATOMIC);
  }
