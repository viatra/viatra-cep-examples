...
public class OutERule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutERule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(E) OUT       ", CLog.ATOMIC_OUT);
  }
