...
public class OutFRule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutFRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(F) OUT       ", CLog.ATOMIC_OUT);
  }
