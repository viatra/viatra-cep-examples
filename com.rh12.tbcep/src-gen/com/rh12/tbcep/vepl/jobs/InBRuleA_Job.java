...
public class InBRuleA_Job extends CepJob<IObservableComplexEventPattern> {
  public InBRuleA_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("( B      )    ", CLog.ATOMIC);
  }
