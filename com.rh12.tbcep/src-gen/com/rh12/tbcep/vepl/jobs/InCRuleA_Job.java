...
public class InCRuleA_Job extends CepJob<IObservableComplexEventPattern> {
  public InCRuleA_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(  C     )    ", CLog.ATOMIC);
  }
