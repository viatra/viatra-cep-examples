...
public class InARule_Job extends CepJob<IObservableComplexEventPattern> {
  public InARule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(A) IN        ", CLog.ATOMIC_IN);
  }
