...
public class OutDRule_Job extends CepJob<IObservableComplexEventPattern> {
  public OutDRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    CLog.print("(D) OUT       ", CLog.ATOMIC_OUT);
  }
