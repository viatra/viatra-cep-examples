...
/**
 * Pattern-specific match representation of the bodymodel.ymca.bentRightArm pattern,
 * to be used in conjunction with {@link BentRightArmMatcher}.
 * 
...
public abstract class BentRightArmMatch extends BasePatternMatch {
  private Body fB;
  ...
  private BentRightArmMatch(final Body pB, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
    this.fB = pB;
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
  ...
  public List<String> parameterNames() {
    return BentRightArmMatch.parameterNames;
  }
  ...
  @Override
  public BentRightArmMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BentRightArmMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BentRightArmMatch other = (BentRightArmMatch) obj;
  ...
  @Override
  public BentRightArmQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BentRightArmMatch newEmptyMatch() {
   ...
   * 
   */
  public static BentRightArmMatch newMutableMatch(final Body pB, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
   ...
   * 
   */
  public static BentRightArmMatch newMatch(final Body pB, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
    return new Immutable(pB, pRH, pRE, pRS);
  }
  
  private static final class Mutable extends BentRightArmMatch {
  ...
  private static final class Immutable extends BentRightArmMatch {
