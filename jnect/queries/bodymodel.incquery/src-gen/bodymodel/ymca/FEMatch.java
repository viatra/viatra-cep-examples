...
import bodymodel.ymca.util.FEQuerySpecification;
...
/**
 * Pattern-specific match representation of the bodymodel.ymca.FE pattern,
 * to be used in conjunction with {@link FEMatcher}.
 * 
...
public abstract class FEMatch extends BasePatternMatch {
  private Body fB;
  ...
  private FEMatch(final Body pB, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
    this.fB = pB;
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof FEMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public FEQuerySpecification specification() {
    try {
    	return FEQuerySpecification.instance();
   ...
   * 
   */
  public static FEMatch newEmptyMatch() {
   ...
   * 
   */
  public static FEMatch newMutableMatch(final Body pB, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
   ...
   * 
   */
  public static FEMatch newMatch(final Body pB, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
    return new Immutable(pB, pRH, pRE, pRS, pH);
  }
  
  private static final class Mutable extends FEMatch {
  ...
  private static final class Immutable extends FEMatch {
