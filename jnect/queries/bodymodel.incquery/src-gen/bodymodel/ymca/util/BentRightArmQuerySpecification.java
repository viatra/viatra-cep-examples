...
public final class BentRightArmQuerySpecification extends BaseGeneratedEMFQuerySpecification<BentRightArmMatcher> {
  private BentRightArmQuerySpecification() {
  ...
  @Override
  public BentRightArmMatch newEmptyMatch() {
    return BentRightArmMatch.newEmptyMatch();
  }
  
  @Override
  public BentRightArmMatch newMatch(final Object... parameters) {
    return BentRightArmMatch.newMatch((org.jnect.bodymodel.Body) parameters[0], (org.jnect.bodymodel.RightHand) parameters[1], (org.jnect.bodymodel.RightElbow) parameters[2], (org.jnect.bodymodel.RightShoulder) parameters[3]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static BentRightArmQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      new ExpressionEvaluation(body, new IExpressionEvaluator() {
      	...
      	public String getShortDescription() {
      		return "Expression evaluation from pattern bentRightArm";
      	}
  ...
  private static boolean evaluateExpression_1_1(final Float REX, final Float REY, final Float REZ, final Float RHX, final Float RHY, final Float RHZ, final Float RSX, final Float RSY, final Float RSZ) {
    boolean _xblockexpression = false;
    {
      ...
      double _abs = Math.abs(((Math.PI / 2) - angleBetween));
      _xblockexpression = (_abs < YMCAConstants.angleTolerance);
    }
