...
public final class FEQuerySpecification extends BaseGeneratedEMFQuerySpecification<FEMatcher> {
  private FEQuerySpecification() {
  ...
  @Override
  public FEMatch newEmptyMatch() {
    return FEMatch.newEmptyMatch();
  }
  
  @Override
  public FEMatch newMatch(final Object... parameters) {
    return FEMatch.newMatch((org.jnect.bodymodel.Body) parameters[0], (org.jnect.bodymodel.RightHand) parameters[1], (org.jnect.bodymodel.RightElbow) parameters[2], (org.jnect.bodymodel.RightShoulder) parameters[3], (org.jnect.bodymodel.Head) parameters[4]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static FEQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new PositivePatternCall(body, new FlatTuple(var_B, var_RH, var_RE, var_RS), BentRightArmQuerySpecification.instance().getInternalQueryRepresentation());
