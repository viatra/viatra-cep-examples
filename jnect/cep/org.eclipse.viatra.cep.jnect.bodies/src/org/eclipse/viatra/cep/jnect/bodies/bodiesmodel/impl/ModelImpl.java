 ...
 * <ul>
 *   <li>{@link org.eclipse.viatra.cep.jnect.bodies.bodiesmodel.impl.ModelImpl#getBodies <em>Bodies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return BodiesmodelPackage.Literals.MODEL;
	}
	...
	public EList<Body> getBodies() {
		if (bodies == null) {
			bodies = new EObjectContainmentEList<Body>(Body.class, this, BodiesmodelPackage.MODEL__BODIES);
		}
		return bodies;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BodiesmodelPackage.MODEL__BODIES:
