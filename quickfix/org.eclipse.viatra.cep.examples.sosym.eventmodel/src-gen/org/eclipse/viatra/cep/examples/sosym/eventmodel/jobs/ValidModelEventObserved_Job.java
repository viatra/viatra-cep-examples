...
public class ValidModelEventObserved_Job extends Job<IObservableComplexEventPattern> {
  public ValidModelEventObserved_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> activation, final Context context) {
    LoggerWrapper.debug("CEP: \'validModel\' event observed");
  }
