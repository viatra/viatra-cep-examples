...
import org.eclipse.viatra.cep.emf.notification.integration.EcoreNotificationAdapter;
...
public class BaseTests {
	private Car car;
	private EcoreNotificationAdapter notificationAdapter;
	...
	public void setUp() throws Exception {
		...
		notificationAdapter = new EcoreNotificationAdapter(car, cepEngine);
